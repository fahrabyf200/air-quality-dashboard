  ...
  return (
    <div className="min-h-screen bg-[#F1F5F9] dark:bg-[#070d1a] text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <div className="px-6 md:px-8 pt-7 pb-5">
        ...
        <p className="text-slate-500 text-xs mt-1">Laporkan kendala atau pertanyaan Anda kepada kami</p>
      </div>

      <div className="px-6 md:px-8 pb-10 max-w-5xl mx-auto space-y-8">
          ...
          {[
            {
              ...
              action: () => window.open(`https://wa.me/${WA_ADMIN}?text=${encodeURIComponent('Halo Admin SkyWatch, saya butuh bantuan.')}`, '_blank'),
              cta: 'Chat Sekarang'
            },
            {
              icon: Mail,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-2">
              <div className="w-1.5 h-5 bg-[#a3e635] rounded-full" />
              ...
              {sent && (
                <div className="mb-6 flex flex-col items-center text-center py-4">
                  ...
                  <button
                    ...
                    className="mt-4 px-5 py-2 rounded-xl bg-[#a3e635] text-[#0a0f1a] font-black text-xs uppercase tracking-wider"
                  >
          ...
          <div className="space-y-5">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full py-4 rounded-2xl border-2 border-[#25D366]/30 bg-[#25D366]/5 hover:bg-[#25D366]/10 text-[#25D366] font-black text-sm transition-all group"
            >
