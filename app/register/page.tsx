...
import { Wind, Lock, Mail, User, ArrowRight, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-[#070d1a] p-6">
      <div className="w-full max-w-md bg-white dark:bg-[#0d1425] rounded-3xl p-8 shadow-2xl border border-slate-200 dark:border-white/10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Daftar Akun</h1>
          <p className="text-sm text-slate-500 mt-1">Buat akses untuk SkyWatch Dashboard</p>
        </div>
