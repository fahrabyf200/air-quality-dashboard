...
function Footer() {
  return (
    <footer className="border-t border-slate-200 dark:border-white/5 bg-[#FFFFFF] dark:bg-[#050912] py-12 text-slate-500 text-xs mt-auto transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 text-left">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h5 className="text-slate-900 dark:text-white font-black uppercase text-xs tracking-wider">SkyWatch</h5>
          </div>
        ...
        <div>
          <h6 className="text-slate-900 dark:text-white font-bold uppercase tracking-wider mb-4">Navigasi</h6>
          <ul className="space-y-2.5 font-medium">
            <li><Link href="/" className="hover:text-slate-900 dark:hover:text-white transition-colors">Dashboard</Link></li>
            <li><Link href="/monitoring" className="hover:text-slate-900 dark:hover:text-white transition-colors">Monitoring</Link></li>
            <li><Link href="/reports" className="hover:text-slate-900 dark:hover:text-white transition-colors">Reports</Link></li>
            <li><Link href="/education" className="hover:text-slate-900 dark:hover:text-white transition-colors">About &amp; Safety</Link></li>
          </ul>
        </div>

        <div>
          <h6 className="text-slate-900 dark:text-white font-bold uppercase tracking-wider mb-4">Fitur Teknis</h6>
        ...
        <div>
          <h6 className="text-slate-900 dark:text-white font-bold uppercase tracking-wider mb-4">Kontak Layanan</h6>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-slate-200 dark:border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 font-medium">
      ...
      <body className="bg-[#F1F5F9] dark:bg-[#070d1a] text-slate-900 dark:text-white antialiased transition-colors duration-300">
        ...
        >
          <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 overflow-y-auto pb-28 lg:pb-0 relative flex flex-col justify-between">
              {/* Konten halaman — diberi blur jika terkunci */}
              <div className={`flex-1 ${isLocked ? "filter blur-sm pointer-events-none select-none opacity-60 transition-all duration-500" : ""}`}>
                {children}
              </div>
